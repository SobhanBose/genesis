...
from .models.improved_pathogenicity_model import create_model, get_model_summary
from .models.feature_engineering import GenomicFeatureEngineer
from .models.loss_functions import get_loss_function
from .utils.logger import Logger
from .models.ref_alt_embeddings import KmerGenerator
...
class FederatedServer:
    ...
    def __init__(self, server_config_path: str = None, data_config_path: str = None, 
                 model_config_path: str = None, federated_config_path: str = None, run_id: str = None):
        """
        ...
        Args:
            ...
            run_id: Unique identifier for the training run (for logging)
        ...
        # Initialize logger with run-specific directory if run_id provided
        if run_id:
            log_dir = f'logs/runs/{run_id}'
            self.logger = Logger(log_dir=log_dir, run_id=run_id)
        else:
            # Fallback to system-level logging
